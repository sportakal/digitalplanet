...
$paymentMeans->setPaymentMeansCode(PaymentMeansCodes::CREDIT_CARD);
...
$SendEArchiveDataWithTemplateCodeRequest = new \Sportakal\Digitalplanet\Requests\SendEArchiveDataWithTemplateCodeRequest($options->getCorporateCode(), $invoices, 'MANUAL', '', '');

$response = \Sportakal\Digitalplanet\Make::exec($SendEArchiveDataWithTemplateCodeRequest, $options);
